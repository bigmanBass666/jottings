...
1. The fence prevents the dog ____ (escape).  
::: details 答案  
**答案：from escaping**（主动语态，狗主动逃跑被阻止）  
:::  

2. The password protects the file ____ (access) by others.  
::: details 答案  
**答案：from being accessed**（被动语态，文件被他人访问）  
:::  

3. Heavy snow prevented the train ____ (run) on time.  
::: details 答案  
